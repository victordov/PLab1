...
public class Universitate {
	...
	Universitate(long u_ID, String u_Denumirea, String u_Adresa, String u_Telefon) {
		this.setU_id(u_ID);
	...
	public void printUnv() {
		System.out.println(this.getU_id() + "\t" + this.getNume_univer() + "\t"
				+ this.getAdresa() + "\t" + this.getTelefon());
	}
	public String toString(){
		return this.getU_id()+"\t"+this.getNume_univer()+"\t"+this.getAdresa()+"\t"+this.getTelefon();
	}
